...
public final class ActivityIntroductionBinding implements ViewBinding {
  ...
  private ActivityIntroductionBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout containerButton, @NonNull TabLayout tabLayout,
  ...
  public static ActivityIntroductionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout containerButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityIntroductionBinding((ConstraintLayout) rootView, containerButton,
          tabLayout, viewPager);
    }
